...
# Test unfreezing
python main.py --data_dir acl --database RadImageNet --model_name ResNet50 --structure unfreezetop2 --verbose
python main.py --data_dir acl --database ImageNet --model_name ResNet50 --structure unfreezetop1 --verbose
