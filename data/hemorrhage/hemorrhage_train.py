...
parser.add_argument("--database", type=str, help="choose RadImageNet/ImageNet/CT")
parser.add_argument(
...
df_train = pd.read_csv("dataframe/hemorrhage_train.csv")
df_val = pd.read_csv("dataframe/hemorrhage_val.csv")
